...
-- 游客：POST /api/guest/session 写入 device_id、is_guest=1、credits=100（见 constants.GUEST_INITIAL_CREDITS）
-- 正式注册：无 Authorization 时 INSERT is_guest=0、credits=1000；Bearer 游客 JWT 时原地 UPDATE 同一行
CREATE TABLE users (
    id TEXT PRIMARY KEY,
